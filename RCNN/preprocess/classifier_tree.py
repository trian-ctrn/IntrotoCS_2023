...
if __name__ == "__main__":
    ...
    classifier_directory = "classifier_ver13"
    check_directory(classifier_directory)
    ...
    for name in ['train', 'val']:
        ...
        dst_directory = os.path.join(classifier_directory, name)
        classifier_image_directory = os.path.join(dst_directory, 'images')
        classifier_annotation_directory = os.path.join(dst_directory, 'labels')
        check_directory(dst_directory)
        check_directory(classifier_image_directory)
        check_directory(classifier_annotation_directory)
        ...
        for id in name_id:
            ...
            dst_annotation_positive_path = os.path.join(classifier_annotation_directory, f"IMG_{id}_1.csv")
            dst_annotation_negative_path = os.path.join(classifier_annotation_directory, f"IMG_{id}_0.csv")
            dst_jpeg_path = os.path.join(classifier_image_directory, f"IMG_{id}.jpg")
